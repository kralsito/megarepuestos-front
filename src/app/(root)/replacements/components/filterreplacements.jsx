  ...
  return (
    <div className="mb-6">
      <button 
        ...
        className="flex items-center px-4 py-2 bg-primary-yellow rounded-lg shadow-md hover:bg-gray-300 transition-colors text-black"
      >
        ...
        <form onSubmit={handleSubmit} className="mt-2 bg-white p-4 rounded-lg shadow-md">
          ...
          <div className="mt-4 flex justify-end space-x-2">
            <button
              type="button"
              onClick={handleReset}
              className="px-4 py-2 bg-red-800 text-white rounded-md hover:bg-red-400 transition-colors"
            >
              Limpiar filtros
            </button>
            <button
